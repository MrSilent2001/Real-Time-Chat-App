...
<template>
  <div>
    ...
    <div 
        ...
        class="flex items-center justify-start w-full gap-5 px-8 py-3 bg-gray-100 border shadow-lg border-b-gray-200"
        @click="selectChat(chat)"
    >
      <div class="flex items-center justify-center h-12 bg-blue-200 rounded-full w-14">N</div>
      <div class="flex items-center justify-between w-full">
        <p class="text-center">{{ chat.users[1]?.username }}</p>
